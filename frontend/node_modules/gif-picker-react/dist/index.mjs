...
`);function ve(e){return d__default.createElement("div",{...e,className:`gpr-placeholder ${e.className||""}`,style:{width:e.width,height:e.height,...e.style}})}var b=ve;function Pe(){let e=useContext(l);return d__default.createElement(b,{className:"gpr-category-placeholder",height:e.categoryHeight,width:"100%"})}var D=Pe;a(`.GifPickerReact .gpr-category-list{display:grid;grid-gap:var(--gpr-category-list-padding);flex:1;grid-auto-rows:min-content;overflow-y:scroll;padding:var(--gpr-body-padding)}
...
`);function we({image:e,text:r,onClick:o}){let t=useContext(l);return d__default.createElement("button",{type:"button",className:"gpr-btn gpr-category",style:{height:t.categoryHeight},"data-testid":"gpr-category",onClick:o},d__default.createElement("img",{src:e,loading:"lazy"}),d__default.createElement("div",{className:"gpr-category-overlay"},d__default.createElement("div",{className:"gpr-category-name"},r)))}var k=we;function Ge({image:e,name:r}){let[o,t]=useContext(s);function n(){let i=Object.assign({},o);i.searchTerm=r,t(i);}return d__default.createElement(k,{image:e,text:r,onClick:n})}var K=Ge;a(`.GifPickerReact .gpr-icn-trending{background-color:transparent;background-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48'%3E%3Cpath fill='%23fff' d='M6.3 37 4 34.7l15-15 8 8.05L41.9 11l2.1 2.05-17 19.2-8-7.95Z'/%3E%3C/svg%3E");background-repeat:no-repeat;background-size:20px;height:20px;width:20px}.GifPickerReact .gpr-category .gpr-text-trending-category{align-items:center;display:flex;gap:4px}
`);function Ie({image:e}){let[r,o]=useContext(s);function t(){let n=Object.assign({},r);n.showTrending=true,o(n);}return d__default.createElement(k,{image:e,onClick:t,text:d__default.createElement("div",{className:"gpr-text-trending-category"},d__default.createElement("div",{className:"gpr-icn-trending"}),d__default.createElement("span",null,"Trending GIFs"))})}var _=Ie;function Le({categories:e,trending:r,columnsCount:o}){var n;function t(){if(!e)return;let g=(e.length+1)%o;return g==0?e:e==null?void 0:e.slice(0,-g)}return d__default.createElement("div",{className:"gpr-category-list",style:{gridTemplateColumns:`repeat(${o}, 1fr)`}},e&&r?d__default.createElement(d__default.Fragment,null,d__default.createElement(_,{image:r.url}),(n=t())==null?void 0:n.map((i,c)=>d__default.createElement(K,{key:c,image:i.image,name:i.name}))):d__default.createElement(d__default.Fragment,null,[...Array(10*o)].map((i,c)=>d__default.createElement(D,{key:c}))))}var z=Le;a(`.GifPickerReact .gpr-gif-list{display:flex;flex:1;flex-direction:row;gap:var(--gpr-category-list-padding);overflow-y:scroll;padding:var(--gpr-body-padding)}.GifPickerReact .gpr-gif-list-column{display:grid;flex:1;grid-gap:var(--gpr-category-list-padding);grid-auto-rows:min-content;grid-template-columns:1fr;grid-template-rows:auto 1fr}.GifPickerReact .gpr-gif-list-no-result{align-items:center;display:flex;flex:1;justify-content:center;padding-bottom:30%}
`);a(`.GifPickerReact .gpr-result-placeholder{border-radius:var(--gpr-category-border-radius)}
`);function Fe({height:e,showDelay:r}){let[o,t]=useState(false);return useEffect(()=>{if(o)return;function n(){t(true);}let i=setTimeout(n,r);return ()=>clearTimeout(i)},[]),d__default.createElement(b,{className:"gpr-result-placeholder",height:e,width:"100%",style:{opacity:o?1:0}})}var O=Fe;var X=[[120,100,130,175,154,110],[150,115,135,154,145,170],[140,125,120,150,100,125],[130,145,175,120,135,100]];function He({columnsCount:e,showDelay:r=70}){return d__default.createElement("div",{className:"gpr-gif-list"},[...Array(e)].map((o,t)=>d__default.createElement("div",{className:"gpr-gif-list-column",key:t},X[t%X.length].map((n,i)=>d__default.createElement(O,{key:i,height:n,showDelay:(i+1)*r*e+r*t})))))}var J=He;a(`.GifPickerReact .gpr-result-image{border-radius:var(--gpr-category-border-radius);cursor:pointer;transition:box-shadow .15s ease-in-out}.GifPickerReact .gpr-result-image img{background-color:var(--gpr-placeholder-color);border-radius:var(--gpr-category-border-radius);height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.GifPickerReact .gpr-result-image:hover{box-shadow:0 0 0 2px var(--gpr-category-border-color-hover)}
`);function Be({image:e,searchTerm:r}){let o=useContext(l),t=useContext(p);function n(){let i=o.onGifClick;i&&i(e),t.registerShare(e,r);}return d__default.createElement("button",{type:"button",className:"gpr-btn gpr-result-image",onClick:n},d__default.createElement("img",{src:e.preview.url,height:e.preview.height,width:e.preview.width,loading:"lazy"}))}var q=Be;function De({isLoading:e,result:r,searchTerm:o,columnsCount:t}){let n=useMemo(()=>Ke(r,t),[r,t]),i=!r||r.images.length<=0;return e?d__default.createElement(J,{columnsCount:t}):i?d__default.createElement("div",{className:"gpr-gif-list-no-result"},d__default.createElement("span",null,"No GIFs found!")):d__default.createElement("div",{className:"gpr-gif-list"},n.map((c,g)=>d__default.createElement("div",{className:"gpr-gif-list-column",key:g},c.map(u=>d__default.createElement(q,{key:u.id,image:u,searchTerm:o})))))}function Ke(e,r=2){if(!e)return [];let o=new Array(r).fill(null).map(()=>[]),t=new Array(r).fill(0);for(let n of e.images){let i=n.preview.height/n.preview.width,c=t.indexOf(Math.min(...t));o[c].push(n),t[c]+=i;}return o}var P=De;function Xe({searchTerm:e,columnsCount:r}){let[o,t]=useState(null),[n,i]=useState(true),c=useContext(p);return useEffect(()=>{i(true);async function g(){let m=await c.search(e);t(m),i(false);}let u=setTimeout(()=>g(),800);return ()=>clearTimeout(u)},[e]),d__default.createElement(P,{isLoading:n,columnsCount:r,result:o,searchTerm:e})}var Y=Xe;function qe({columnsCount:e}){let[r,o]=useState(null),[t,n]=useState(true),i=useContext(p);return useEffect(()=>{n(true),(async()=>{let c=await i.trending();o(c),n(false);})();},[]),d__default.createElement(P,{columnsCount:e,isLoading:t,result:r})}var Q=qe;var Ye=170;function Ze({width:e}){let[r,o]=useState(void 0),[t,n]=useState(void 0),[i]=useContext(s),[c,g]=useState(1),u=useContext(p),m=useRef(null);return useEffect(()=>{(async()=>{let E=await u.categories();o(E);let y=await u.trending(1);n(y.images[0]);})();},[]),useEffect(()=>{let E=m.current?m.current.offsetWidth:0,y=Math.floor(E/Ye);y<1&&(y=1),g(y);},[m.current,e]),d__default.createElement("div",{className:"gpr-body",ref:m},i.showTrending?d__default.createElement(Q,{columnsCount:c}):i.searchTerm?d__default.createElement(Y,{columnsCount:c,searchTerm:i.searchTerm}):d__default.createElement(z,{columnsCount:c,categories:r,trending:t}))}var re=Ze;a(`.GifPickerReact .gpr-header{border-bottom:1px solid var(--gpr-picker-border-color);min-height:0;padding:var(--gpr-header-padding)}
